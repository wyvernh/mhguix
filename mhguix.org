...
*** science
A collection of science packages not packaged in GNU Guix.
#+begin_src scheme :tangle ./wyvernh/packages/science.scm
...
*** misc
#+begin_src scheme :tangle ./wyvernh/packages/misc.scm
...
The installation procedure for gum right now is just to copy the binary:
#+begin_src scheme :tangle ./wyvernh/packages/misc.scm
  (define-public gum
    (package
     (name "gum")
